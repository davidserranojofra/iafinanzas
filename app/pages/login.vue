...
<template>
  <div class="flex flex-col items-center justify-center min-h-screen px-6 bg-dracula-bg">
    ...
    <div class="flex flex-col items-center mb-10">
      <img src="/icono.png" alt="Logo IAFinanzas" class="w-16 h-16 rounded-2xl mb-4 shadow-lg object-contain" />
      <h1 class="text-2xl font-bold text-dracula-text">IA Finanzas</h1>
    ...
    <div class="w-full max-w-sm bg-dracula-card2 rounded-3xl p-6 border border-dracula-muted/20">
      ...
      <form class="flex flex-col gap-4" @submit.prevent="submit">
        ...
        <div class="flex flex-col gap-1.5">
          ...
          <div class="relative">
            <svg class="absolute left-3 top-1/2 -translate-y-1/2 text-dracula-muted" width="16" height="16"
              viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
              <path d="M4 4h16c1.1 0 2 .9 2 2v12c0 1.1-.9 2-2 2H4c-1.1 0-2-.9-2-2V6c0-1.1.9-2 2-2z" />
              <polyline points="22,6 12,13 2,6" />
            </svg>
            <input v-model="email" type="email" required autocomplete="email" placeholder="vos@ejemplo.com"
        ...
        <p v-if="error" class="text-xs rounded-xl px-3 py-2" :class="error.startsWith('✓')
          ? 'text-dracula-green bg-dracula-green/10'
          : 'text-dracula-red bg-dracula-red/10'">{{ error }}</p>
      ...
      <div class="flex items-center gap-3 my-5">
        ...
        <span class="text-xs text-dracula-muted">o continua con</span>
        <div class="flex-1 h-px bg-dracula-muted/20" />
      </div>

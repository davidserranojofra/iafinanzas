      ...
      <div v-if="showPrompt"
        ...
        <div v-if="isAndroid" class="flex flex-col gap-3">
          <p class="text-xs text-dracula-muted leading-relaxed">
            Instalá la app en tu teléfono Android para acceder rápido desde tu pantalla de inicio y utilizar el soporte
            offline.
          </p>
          <button
            class="w-full py-3 rounded-2xl text-xs font-bold text-white transition-opacity active:opacity-80 shadow-md"
            style="background: linear-gradient(135deg, #bd93f9, #ff79c6)" @click="installAndroid">
            Instalar aplicación
          </button>
        </div>
        ...
        <div v-else-if="isIOS" class="flex flex-col gap-3">
          ...
          <div class="flex flex-col gap-2 bg-dracula-bg/40 rounded-2xl p-3 border border-dracula-muted/5">
            <div class="flex items-center gap-2.5 text-xs text-dracula-text">
              <span
                class="w-5 h-5 rounded-full bg-dracula-muted/20 flex items-center justify-center font-bold text-[10px] shrink-0">1</span>
              <span>Pulsa el botón de compartir <span
                  class="inline-block align-middle font-semibold text-dracula-purple">
                  <svg aria-hidden="true" class="inline-block -mt-1" width="16" height="16" viewBox="0 0 24 24"
            ...
            <div class="flex items-center gap-2.5 text-xs text-dracula-text">
              <span
                class="w-5 h-5 rounded-full bg-dracula-muted/20 flex items-center justify-center font-bold text-[10px] shrink-0">2</span>
              <span>Toca <span class="font-semibold text-dracula-pink">"ver más"</span>.</span>
            </div>
            <div class="flex items-center gap-2.5 text-xs text-dracula-text">
              <span
                class="w-5 h-5 rounded-full bg-dracula-muted/20 flex items-center justify-center font-bold text-[10px] shrink-0">3</span>
              <span>Elige <span class="font-semibold text-dracula-pink">"Añadir a la pantalla de inicio"</span>.</span>
            </div>
          </div>
        </div>
      </div>
